...
t1.to(".esfera", { delay: 0.5, duration: 1, scale: 1.5, display: "none" }, "start")
  ...
  .to("#hero", { delay: 5, duration: 4, backgroundImage: "linear-gradient(90deg, rgba(255,247,173,1) 0%, rgba(255,169,249,1) 100%)" }, "start")
  ...
  .to("#hero", { delay: 7.5, duration: 5, backgroundImage: "linear-gradient(90deg, rgba(205,255,216,1) 0%, rgba(148,185,255,1) 100%)" }, "start")
  .to(".Tercero", { delay: 7.5, duration: 5, scale: 1 }, "start")
  .to(".particulas2", { delay: 7.5, duration: 5, scale: 1.5, opacity: 1 }, "start");
